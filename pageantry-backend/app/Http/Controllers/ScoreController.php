...
class ScoreController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $validated = $request->validate([
            ...
            'category' => 'required|in:production,formal_attire,uniform_attire,swimwear,gown,qa_preliminary,qa',
    ...
    {
        $categories = ['production', 'formal_attire', 'uniform_attire', 'swimwear', 'gown', 'qa_preliminary', 'qa'];
