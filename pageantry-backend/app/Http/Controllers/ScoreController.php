...
class ScoreController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $validated = $request->validate([
            ...
            'category' => 'required|in:production,formal_attire,uniform_attire,ethnic_attire,gown,qa_preliminary,qa',
    ...
    public function analytics(Request $request): JsonResponse
    {
        ...
        $query = Candidate::where('is_active', true);
    ...
    {
        $categories = ['production', 'formal_attire', 'uniform_attire', 'ethnic_attire', 'gown', 'qa_preliminary', 'qa'];
