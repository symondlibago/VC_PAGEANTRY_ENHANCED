    ...
    public function index(Request $request): JsonResponse
    {
        ...
        $judgesWithProgress = $judges->map(function ($judge) {
            return [
                ...
                'progress' => [
                    'production' => $judge->getJudgingProgress('production'),
                    'formal_attire' => $judge->getJudgingProgress('formal_attire'),
                    'uniform_attire' => $judge->getJudgingProgress('uniform_attire'),
                    'ethnic_attire' => $judge->getJudgingProgress('ethnic_attire'),
                    'gown' => $judge->getJudgingProgress('gown'),
                    'qa_preliminary' => $judge->getJudgingProgress('qa_preliminary'),
